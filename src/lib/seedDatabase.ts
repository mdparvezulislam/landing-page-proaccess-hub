...
export async function seedDatabase() {
  ...
  if (vipPlanCount === 0) {
    ...
    await VIPPlan.create({
      ...
      officialStarterBDT: 5000,
      officialStarterUSDT: 40,
      officialMonthlyBDT: 500,
      officialMonthlyUSDT: 4,

      // Starter Track
      starterOfficialBDT: 15000,
      starterOfficialUSDT: 120,
      starterPriceBDT: 3000,
      starterPriceUSDT: 24,
      starterMonthlyBDT: 399,
      starterMonthlyUSDT: 3,
      starterEnableDiscount: false,
      starterDiscountPercent: 30,
      starterDiscountPriceBDT: 11199,
      starterDiscountPriceUSDT: 90,
