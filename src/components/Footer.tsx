      ...
      <div className="container mx-auto px-4 lg:px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-24 mb-16 lg:mb-24">
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-4 mb-6 lg:mb-8 group">
        ...
        <div className="pt-8 lg:pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 lg:gap-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 order-1 md:order-2">
             <Link to="/admin-dashboard" className="px-3 lg:px-4 py-1.5 lg:py-2 rounded-xl bg-white/5 border border-white/10 text-[9px] lg:text-[10px] font-black uppercase tracking-widest text-text-muted hover:text-text-primary hover:bg-white/10 transition-all">
                Admin
             </Link>
