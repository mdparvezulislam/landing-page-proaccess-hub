        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold mb-8 leading-tight">
              ...
              <span className="grad-text">{language === 'en' ? 'Digital Future' : 'ডিজিটাল ভবিষ্যৎ'}</span>{' '}
                  ...
                  <div className="glass-card p-6 rounded-2xl border-white/20 backdrop-blur-2xl">
                    <div className="flex items-center gap-4 mb-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-text-secondary uppercase font-bold tracking-widest">Happy Members</p>
                      </div>
                    </div>
                  </div>
                </div>
