...
export const TrustBadges = ({ data }: { data: TrustBadgeItem[] }) => {
  ...
  return (
    <section className="py-14 lg:py-20 bg-white/[0.01] border-y border-white/5 relative overflow-hidden">
          ...
          {visibleBadges.map((badge, i) => {
            ...
            return (
              <motion.div
                ...
                className="flex items-center gap-4 lg:gap-6 p-5 lg:p-8 rounded-[24px] lg:rounded-[32px] glass-card border-white/5 hover:bg-white/[0.05] transition-all duration-500 group shadow-xl"
              >
                ...
                <div>
                   <h4 className="text-base lg:text-xl font-black text-text-primary tracking-tight">
