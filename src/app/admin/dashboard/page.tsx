            ...
            return (
              ...
              >
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${
                  isActive ? 'bg-primary text-white' : 'bg-white/5 text-text-muted group-hover:text-text-primary'
                }`}>
                ...
                {isActive && isSidebarOpen && <ChevronRight className="w-4 h-4 text-primary" />}
              </button>
            );
          })}
        </nav>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className="text-sm font-black tracking-tighter">Admin User</p>
                <p className="text-[10px] text-primary font-black uppercase tracking-widest">Master Control</p>
              </div>
