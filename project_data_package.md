# Pro Access VIP Hub - Complete Data Models & Seed Data

This document contains all the necessary data structures and initial content for migrating the Pro Access VIP Hub from `localStorage` to a permanent database.
...
## 2. Complete Initial State Data (JSON)

This JSON represents the current default state of the platform.
...
```json
{
  ...
  "products": [
    {
      ...
      "features": [
        { "id": "f1", "textEn": "Gemini Pro + 5TB Drive 12M", "textBn": "জেমিনি প্রো + ৫টিবি ড্রাইভ ১২ মাস", "visible": true, "highlighted": false, "order": 1, "includedInPlanIds": ["p1", "p2", "p3"] },
        { "id": "f2", "textEn": "Adobe Photoshop Pro – 1 Year", "textBn": "অ্যাডোব ফটোশপ প্রো - ১ বছর", "visible": true, "highlighted": false, "order": 2, "includedInPlanIds": ["p2", "p3"] },
        { "id": "f3", "textEn": "Canva Pro – 3 Years", "textBn": "ক্যানভা প্রো - ৩ বছর", "visible": true, "highlighted": false, "order": 3, "includedInPlanIds": ["p3"] }
      ]
    }
  ],
  "navbar": {
  ...
  "countdown": {
    "enabled": true,
    "targetDate": "2024-05-13T00:00:00.000Z",
